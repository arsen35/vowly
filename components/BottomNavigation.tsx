    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-[50] px-5 pb-8 pt-2 pointer-events-none">
      <div className="bg-white/95 dark:bg-theme-dark backdrop-blur-3xl border border-gray-100 dark:border-gray-800 rounded-[24px] flex items-center justify-around h-16 pointer-events-auto max-w-sm mx-auto shadow-[0_10px_40px_rgba(0,0,0,0.15)]">
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition-all ${currentView === ViewState.FEED ? 'text-wedding-500' : 'text-gray-400 dark:text-gray-600'}`}
        >
          <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-6 h-6">
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition-all ${currentView === ViewState.BLOG ? 'text-wedding-500' : 'text-gray-400 dark:text-gray-600'}`}
        >
          <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-6 h-6">
        ...
        <div className="flex-1 flex justify-center items-center">
            <button 
              ...
              className="w-12 h-12 bg-wedding-500 text-white rounded-[16px] flex items-center justify-center transform active:scale-90 transition-all shadow-lg shadow-wedding-500/30"
            >
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition-all ${currentView === ViewState.CHAT ? 'text-wedding-500' : 'text-gray-400 dark:text-gray-600'}`}
        >
          <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-6 h-6">
        ...
        <button 
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition-all ${currentView === ViewState.PROFILE ? 'text-wedding-500' : 'text-gray-400 dark:text-gray-600'}`}
        >
          <svg fill="none" viewBox="0 0 24 24" strokeWidth={1.2} stroke="currentColor" className="w-6 h-6">
